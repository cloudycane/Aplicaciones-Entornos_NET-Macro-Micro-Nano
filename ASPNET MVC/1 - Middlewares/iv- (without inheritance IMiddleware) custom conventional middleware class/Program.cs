...
// ADD THE CONVENTIONAL MIDDLEWARE SERVICE 
builder.Services.AddTransient<ConventionalMiddleware>();
...
app.UseMiddleware<ConventionalMiddleware>(); // CONVENTIONAL MIDDLEWARE
